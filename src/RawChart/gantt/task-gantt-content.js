...
export const TaskGanttContent = ({
    ...
    useEffect(() => {
        const handleMouseMove = async (event) => {
            ...
            const { isChanged, changedTask } = handleTaskBySVGMouseEvent(cursor.x, barEvent.action, barEvent.changedTask, xStep, timeStep, initEventX1Delta);
        ...
        const handleMouseUp = async (event) => {
            ...
            const { changedTask } = handleTaskBySVGMouseEvent(cursor.x, action, selectedTask, xStep, timeStep, initEventX1Delta);
